...
export const DEFAULT_SETTINGS = {
  ...
  [COMMANDS_SETTINGS_KEY]: {
    ...
    [APEX_CLASS_SETTINGS_KEY]: false,
    [APEX_TRIGGER_SETTINGS_KEY]: false,
    [EXPERIENCE_SITE_SETTINGS_KEY]: true,
    [LIGHTNING_APP_SETTINGS_KEY]: true,
    [PERMISSION_SET_SETTINGS_KEY]: true,
    [PERMISSION_SET_GROUP_SETTINGS_KEY]: true,
    [USERS_SETTINGS_KEY]: true,
