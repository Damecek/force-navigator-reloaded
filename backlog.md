...
- [x] Batch-updated open Dependabot dependency PRs (npm + GitHub Actions) on 2026-03-27, with `eslint` kept on v9 for current Salesforce lint-stack compatibility
